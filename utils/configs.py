...
parser.add_argument("--news_model", type=str, default="deberta", help="News model")

# Model Hyperparameters
parser.add_argument("--scaler_path", type=str, default="models/lstm_model_scaler.pkl", help="Path to the scaler file")
