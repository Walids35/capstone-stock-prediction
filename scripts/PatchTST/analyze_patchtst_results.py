...
Analyzes TXT files from PatchTST output and calculates mean metrics across 5 tickers
...
PATCHTST_DIR = 'reports/output/PatchTST'

def parse_metrics_from_file(file_path):
    """
    Parse metrics from a TXT file.
    Returns the metrics dictionary from line 12 (PatchTST format).
    """
    try:
